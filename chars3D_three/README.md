...
Build you App using [Three](https://threejs.org/) and your own fonts, this is the same code as the "Demo". 
We removed some functions used in "demo", to be more "clean" end easiest to create something new.
