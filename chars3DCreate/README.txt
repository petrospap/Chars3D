...
----------------------------------------------------------------------------------------------------------
NOTE: this script builded for internal use only, if you add it to public you must provide security patch,
AND for all binary's encode/decode
----------------------------------------------------------------------------------------------------------
...
npm undeprecate : Undeprecate a version of a package
